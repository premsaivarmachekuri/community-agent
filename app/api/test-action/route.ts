...
const testConversations: ConversationMessage[][] = [
  ...
  [
    { role: 'user', content: "What's the best channel for reporting a login bug?" },
    {
      role: 'assistant',
      content:
  ...
  [
    {
      role: 'user',
      content: 'I keep getting a 500 error when the bot tries to respond. Any ideas?',
    },
    {
      role: 'assistant',
      content:
...
const actions: TestAction[] = [
  ...
  },
  {
    type: 'flagged',
    channel: 'DM',
    description: 'Flagged issue to community lead: User reports suspicious activity',
